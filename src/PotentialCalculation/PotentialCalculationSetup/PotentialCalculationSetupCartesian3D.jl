...
function set_point_types_and_fixed_potentials!(point_types::Array{PointType, 3}, potential::Array{T, 3},
    ...
    if NotOnlyPaintContacts
        for contact in det.contacts
            ...
            is_inactive_layer_contact = isdefined(det.semiconductor.impurity_density_model, :surface_imp_model) && contact_id in det.semiconductor.impurity_density_model.surface_imp_model.inactive_contact_id
