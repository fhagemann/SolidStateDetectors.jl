...
function get_signal(sim::Simulation{T, CS}, drift_paths::Vector{EHDriftPath{T}}, energy_depositions::Vector{T}, contact_id::Int; Δt::TT = T(5) * u"ns", waveform_unit::Unitful.Units = u"e_au") where {T <: SSDFloat, CS, TT}
