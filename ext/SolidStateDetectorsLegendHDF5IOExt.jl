...
function SolidStateDetectors.simulate_waveforms( mcevents::AbstractVector{<:NamedTuple}, sim::Simulation{T},
                             ...
                             waveform_unit::Unitful.Units = u"e_au",
    ...
    for evtrange in evt_ranges
        ...
        mcevents_sub = simulate_waveforms(mcevents[evtrange], sim; Δt, max_nsteps, diffusion, self_repulsion, number_of_carriers, number_of_shells, waveform_unit, max_interaction_distance, end_drift_when_no_field, geometry_check, verbose)
